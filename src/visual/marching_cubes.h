...
TriangleMesh<Eigen::Vector3f> tesselateCube(float v,
...
const std::array<uint16_t, 256> edgeTable = {
...
const std::vector<std::vector<int>> triTable = {
	{},
	{0, 8, 3},
	{0, 1, 9},
	{1, 8, 3, 9, 8, 1},
...
const std::vector<std::pair<int, int>> edgeToVertex = {
	{0, 1},
	{1, 2},
	{2, 3},
	{3, 0},
